namespace backend_skincare_2023.Models
{
    public class Questionario
    {
        ...
        public Questionario()
        {
            ...
            Perguntas.Add(new PerguntaResposta("Selecione suas necessidades: Você pode escolher até duas opções!", new List<string> { "Acnes e cravos", "Ressecamento", "Melasma e cicatrizes", "Sensibilidade e irritacao", "Prevencao de sinais", "Linhas finas e rugas", "Cuidados pele fumante" }));
        }
    }
}
