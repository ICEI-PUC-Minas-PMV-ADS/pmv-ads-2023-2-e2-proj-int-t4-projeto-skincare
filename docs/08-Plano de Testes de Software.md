...
| Passos 	| - Acessar o navegador <br> - Informar o endereço do site.<br> - Clicar em  Quiz da pele na 'Home page'<br>  - Responder ao ‘Questionário’ <br>  - Responder ‘Sim’ para a pergunta número 3 |
...
|  	|  	|
| **Caso de Teste** 	| CT-06 – Gerar rotinas para problemas específicos|
...
| Passos 	| -	Acessar o navegador <br> - Informar o endereço do site. <br> -	Fazer ‘login’ no site <br> - Clicar em Quiz da pele  na ‘Home page’ <br> - Responder ao ‘Questionário’. <br> 'Clicar ver minha rotina |
...
|  	|  	|
| **Caso de Teste** 	| CT-08 – Questionário	|
